      ...
      builder: (_) => Padding(
        ...
        child: Container(
          ...
          child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            _InputField(
              controller: _phoneController, label: 'Numéro de téléphone',
  ...
  Widget _buildEmpty() {
    return Center(
      child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
        ...
        const Text('Ajoutez au moins un contact\npour continuer.', textAlign: TextAlign.center, style: TextStyle(fontSize: 14, color: AppColors.grayMid)),
      ]),
    );
  }
